      ...
      <div className="relative z-20 flex flex-col items-center w-full px-4">
        <Container>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            ...
            {/* Search bar hanya jika jumlah jurnal > 3 */}
            {journals.length > 3 && (
                ...
                >
                  ...
                  <div className="flex-shrink-0">
                    <div className="bg-gray-200 rounded-xl w-28 h-36 flex items-center justify-center overflow-hidden">
                      <img
                        src={journal.cover || '/cover-jurnal.png'}
                        alt="cover"
                  ...
                  <div className="flex-1 flex flex-col gap-1">
                    ...
                    <div className="flex flex-row gap-2 mt-1">
                      {journal.badges &&
                        journal.badges.map((badge: Badge, idx: number) => (
                          <span
                            key={idx}
                  ...
                  {/* Button hanya "Kunjungi" */}
                  <div className="flex ml-2">
                    <button className="bg-green-900 text-white rounded-xl px-8 py-2 font-semibold hover:bg-green-700">
                      Kunjungi
                    </button>
                  </div>
                </div>
